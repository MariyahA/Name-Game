...
let TotalTime = brushTeeth + chooseClothes + shower + checkphone
...
let Haveto = brushTeeth + shower + chooseClothes
let likes = shower + chooseClothes
let noHavenoLike = checkphone + waitforhumans
/*:
